...
class IndianOutfitNode(EthnicOutfitGenerator):
    RETURN_TYPES = (
        "STRING",
        "INT",
    )
...
NODE_CLASS_MAPPINGS = {
    "IndianOutfitNode": IndianOutfitNode
}
NODE_DISPLAY_NAME_MAPPINGS = {
    "IndianOutfitNode": f'{country_info["flag"]} {country_info["name"]} Outfit'
}
